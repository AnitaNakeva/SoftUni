...
2. Web Application Designs
   ...
   - Уеб приложенията се проектират с два основни подхода:
      ...
      - Multi-Page application (MPA)
         ...
         - Това е традиционният подход, при който всяка промяна на страницата изисква ново зареждане от сървъра.

         - Повечето от логиката на приложението се изпълнява на сървъра, а HTML се генерира на сървъра и се връща като отговор на HTTP заявки.

         - Примери за технологии: ASP.NET Core MVC и Razor Pages.
        
      - Single-Page application (SPA)
    
         - Повечето от потребителския интерфейс се изпълнява в браузъра.

         - Не се изисква презареждане на страницата по време на употреба.

         - Примерите включват Gmail, Facebook и Instagram.

         - Логиката и данните се заявяват независимо един от друг.
...
3. Web Application Architectures
   ...
   - Монолитни приложения
     ...
     - Монолитните приложения представляват единна, интегрирана софтуерна система, в която всички компоненти и функционалности са обединени в една обща единица.
    
     - The simplest form of architecture
    
     - Monolithic apps are recommended for small and mid-sized projects вhere the scope of functionality does not require abstractions

     - In most cases, monolith apps are not desired
    
     - С увеличаването на размера и сложността на монолита, поддръжката и актуализациите стават по-трудни.

     - Внедряването на нови технологии в монолит може да бъде сложно, тъй като всички компоненти са тясно свързани.

   - Service-Oriented Architectures (SOA) (Архитектури ориентирани към услуги)
  
     - SOA е архитектурен стил, който разделя функциите на приложението на по-малки, независими услуги, които комуникират помежду си чрез стандартизирани протоколи.
     ...
     - Услугите могат да се мащабират независимо една от друга.
    
     - Services communicate using Enterprise Service Bus (ESB)
   ...
   - Microservices (Микросървизи)
     ...
     - Микросервисната архитектура представлява разпределена система от множество малки, независимо разгръщаеми услуги, които изпълняват конкретни бизнес функции.
    
     - Всяка услуга е малка по размер и изпълнява конкретна функция.
    
     - Услугите комуникират помежду си чрез HTTP протоколи като REST (Representational State Transfer) и Web API.
...
4. ASP.NET Core MVC vs Razor Pages
   ...
   - ASP.NET Core MVC
     ...
     - Model-View-Controller архитектура: Това е архитектурен шаблон, който разделя приложението на три основни компонента:
         ...
         - Model: Представлява данните на приложението и бизнес логиката.
           
         - View: Отговаря за потребителския интерфейс и представянето на данните.
           
         - Controller: Управлява входните данни на потребителите, взаимодействието между Model и View, и изпълнява бизнес логиката.
